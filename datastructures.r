...
# the data values put into into a vector must be
# of the same data type
# a vector may consist of 1 elementof multiple
# elements
...
# the number od data values isn't suitable for 2 rows
m3 <- matrix(c("a","b","c"), nrow = 2)
m3
...
# can have vecyors of different data types, but the 
...
# my be of any data type and the datastructures in
...
# create a list that includs a list
